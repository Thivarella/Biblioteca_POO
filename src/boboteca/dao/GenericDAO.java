...
public class GenericDAO {
    ...
    Generic getPriorityById(Integer priorityId){
        return getGeneric(priorityId, "SELECT * FROM priority WHERE id=?;");
    }

    private Generic getGeneric(Integer priorityId, String sql) {
        try {
    ...
    Generic getGenderById(Integer genderId){
        return getGeneric(genderId, "SELECT * FROM gender WHERE id=?;");
    }

    Generic getCategoryById(Integer categoryId){
        try {
            conn = ConnectionFactory.getConnection();
