...
public class CreateDatabase {
    ...
    public void createTables(){
        try{
            ...
            sqls.add("CREATE TABLE IF NOT EXISTS category (id INTEGER PRIMARY KEY, label VARCHAR(255) NOT NULL, value INTEGER NOT NULL, additional_value DECIMAL(5,2) NOT NULL);");
            ...
            sqls.add("CREATE TABLE IF NOT EXISTS taxes(id INTEGER PRIMARY KEY, book_id INTEGER NOT NULL, user_id INTEGER NOT NULL, description VARCHAR(255) NOT NULL, value DECIMAL(5,2) NOT NULL, is_paid BOOLEAN NOT NULL, FOREIGN KEY (book_id) REFERENCES books(id), FOREIGN KEY (user_id) REFERENCES user(id));");
